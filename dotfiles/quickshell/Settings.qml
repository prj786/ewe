...
Scope {
    ...
    function writePrefs() {
        var s = '{ "accent": "' + String(Globals.accentColor) + '", "tintBorders": ' + (Globals.tintBorders ? "true" : "false")
              ...
              + ', "lock": ' + (Globals.saverLock ? "true" : "false")
              + ', "lockAfterMin": ' + Number(Globals.saverLockAfterMin) + ' } }'
    ...
    function writeIdleConf() {
        ...
        var s = "# AUTO-GENERATED by the Quickshell Settings app (Screensaver pane). Do not edit by hand.\n"
              ...
              + "}\n"
        var saverSec = Math.max(60, Math.round(Globals.saverMin * 60))
        if (Globals.saverEnabled && !Globals.saverLock) {
            ...
            if (Globals.saverLockAfterMin > 0)
                s += "listener {\n    timeout    = " + (saverSec + Globals.saverLockAfterMin * 60) + "\n    on-timeout = " + lockCmd + "\n}\n"
