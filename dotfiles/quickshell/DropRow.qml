...
Column {
    ...
    Item {
        ...
        Rectangle {
            ...
            Text { id: drChev; anchors.right: parent.right; anchors.rightMargin: 8; anchors.verticalCenter: parent.verticalCenter; text: dr.open ? String.fromCodePoint(0xF0143) : Theme.icChevronDown; font.family: Theme.fontMono; font.pixelSize: 9; color: Theme.fgDim }
