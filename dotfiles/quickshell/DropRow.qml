...
Column {
    ...
    Item {
        ...
        Text { anchors.left: parent.left; anchors.verticalCenter: parent.verticalCenter; text: dr.label; color: Theme.fg1; font.family: Theme.fontText; font.pixelSize: Theme.fsSmall }
        Rectangle {
            anchors.right: parent.right; anchors.verticalCenter: parent.verticalCenter
            width: dr.buttonWidth; height: 26; radius: Theme.r(7)
            color: drMa.containsMouse && !dr.dim ? Theme.bg1Hover : Theme.bg1
            border.color: (dr.open || drBtn.activeFocus) ? Theme.accent : Theme.stroke1; border.width: Theme.borderThin
            ...
            Text { anchors.left: parent.left; anchors.leftMargin: 9; anchors.right: drChev.left; anchors.rightMargin: 4; anchors.verticalCenter: parent.verticalCenter; text: dr.labelFor(dr.value); color: Theme.fg1; font.family: Theme.fontText; font.pixelSize: 11; elide: Text.ElideRight }
            Text { id: drChev; anchors.right: parent.right; anchors.rightMargin: 8; anchors.verticalCenter: parent.verticalCenter; text: dr.open ? Theme.icChevronUp : Theme.icChevronDown; font.family: Theme.fontIcons; font.pixelSize: 9; color: Theme.fg3 }
            ...
            Column {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color: drOMa.containsMouse ? Theme.subtleHover : Theme.subtle
                        Text { anchors.left: parent.left; anchors.leftMargin: 8; anchors.right: parent.right; anchors.rightMargin: 26; anchors.verticalCenter: parent.verticalCenter; text: modelData.label; color: sel ? Theme.accent : Theme.fg1; font.family: Theme.fontText; font.pixelSize: 11; font.weight: sel ? Font.DemiBold : Font.Normal; elide: Text.ElideRight }
